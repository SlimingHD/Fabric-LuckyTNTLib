...
public class UpdateConfigValuesC2SPacket implements LuckyTNTPacket {
	
	public static Identifier NAME = new Identifier(LuckyTNTLib.MODID, "update_config_values_c2s");
	
	public final List<ConfigValue<?>> configValues;

	public UpdateConfigValuesC2SPacket(List<ConfigValue<?>> configValues) {
